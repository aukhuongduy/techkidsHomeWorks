...
public class GameWindow extends Frame implements Runnable {
    ...
    public GameWindow() {
        ...
        enemy = new PlaneController(new Model(r.nextInt(800) + 1, 0, 50, 50), new View(Utils.loadImage("resources/enemy-green-3.png")));
    ...
    public void run() {
        while (true) {
            try {
                ...
                if (count == 100) {
                    enemyBullets.add(EnemyBulletController.createBullet(enemy));
                    count = 0;
                }
                if (enemyBullets != null) {
                    for (EnemyBulletController bullet : enemyBullets
