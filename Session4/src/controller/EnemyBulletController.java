...
public class EnemyBulletController extends Controller {
    ...
    public static EnemyBulletController createBullet(EnemyPlaneController plane){
        EnemyBulletController enemyBulletController = new EnemyBulletController(
                new Model(plane.getModel().getX() + plane.getModel().getWidth() / 2 - 15, plane.getModel().getY() + 30, 30, 30)
